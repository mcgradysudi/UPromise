...
{
//    nowPickerShowTimeLabel = [[UILabel alloc] initWithFrame:CGRectMake(17.0, /*117.0*/ 0.0, 278.5, 18)];
//    [nowPickerShowTimeLabel setBackgroundColor:[UIColor clearColor]];
//    [nowPickerShowTimeLabel setFont:[UIFont systemFontOfSize:18.0]];
//    [nowPickerShowTimeLabel setTextColor: [UIColor colorWithRed:51.0/255 green:51.0/255 blue:51.0/255 alpha:1]];
...
//    [self addSubview:nowPickerShowTimeLabel];
    ...
    timeBroadcastView = [[UIView alloc] initWithFrame:CGRectMake(0, /*140*/ 0.0, 320, 190.0)];
   ...
   // timeBroadcastView.layer.borderWidth = 2.0;
    ...
    UIView *beforeSepLine = [[UIView alloc] initWithFrame:CGRectMake(0, 39, 320, 1.5)];
    [beforeSepLine setBackgroundColor:[UIColor colorWithRed:237.0/255 green:237.0/255 blue:237.0/255 alpha:1]];
    [timeBroadcastView addSubview:beforeSepLine];
    UIView *middleSepView = [[UIView alloc] initWithFrame:CGRectMake(0, 75, 320, 38)];
    
    [middleSepView setBackgroundColor:[UIColor colorWithRed:249.0/255 green:138.0/255 blue:20.0/255 alpha:1]];
    [timeBroadcastView addSubview:middleSepView];
    UIView *bottomSepLine = [[UIView alloc] initWithFrame:CGRectMake(0, 150.5, 320, 1.5)];
    [bottomSepLine setBackgroundColor:  [UIColor colorWithRed:237.0/255 green:237.0/255 blue:237.0/255 alpha:1]
];
...
{
    yearScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(0, 0, 80.0, 190.0)];
...
{
    monthScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(80.0, 0, 60, 190.0)];
...
{
    dayScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(140.0, 0, 60, 190.0)];
...
{
    hourScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(200.0, 0, 53.0, 190.0)];
...
{
    minuteScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(253, 0, 53, 190.0)];
...
{
    secondScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(235.5, 0, 46.0, 190.0)];
...
- (void)setAfterScrollShowView:(MXSCycleScrollView*)scrollview  andCurrentPage:(NSInteger)pageNumber
{
    ...
    [oneLabel setTextColor:[UIColor colorWithRed:186.0/255 green:186.0/255 blue:186.0/255 alpha:1]];
    ...
    [twoLabel setTextColor:[UIColor colorWithRed:113.0/255 green:113.0/255 blue:113.0/255 alpha:1]];
    ...
    [threeLabel setTextColor:[UIColor colorWithRed:113.0/255 green:113.0/255 blue:113.0/255 alpha:1]];
    ...
    [fourLabel setTextColor:[UIColor colorWithRed:186.0/255 green:186.0/255 blue:186.0/255 alpha:1]];
}
...
- (void)selectSetBroadcastTime
{
   ...
   // NSDateFormatter *myFromat = [[NSDateFormatter alloc]init];
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    [dateFormatter setDateFormat:@"yyyy-MM-dd HH:mm:ss"];
    NSDate *date = [dateFormatter dateFromString:taskDateString];
   // NSLog(@"%@", date);
...
- (void)scrollviewDidChangeNumber
{
  ...
  // NSLog(@"%@", selectDate);
    ...
    if (NSOrderedAscending == [selectDate compare:nowStrDate]) {//选择的时间与当前系统时间做比较
        [selectTimeIsNotLegalLabel setTextColor:  [UIColor colorWithRed:155.0/255 green:155.0/255 blue:155.0/255 alpha:1]
];
