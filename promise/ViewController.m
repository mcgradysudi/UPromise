...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (![[NSUserDefaults standardUserDefaults] boolForKey:@"everLaunched"]) {
       ...
       // NSLog(@"first launch第一次程序启动");
        ...
        [self performSegueWithIdentifier:@"firstLaunchEnd" sender:self];
...
- (void)showIntroWithCrossDissolve {
   ...
   // page1.desc = @"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.";
    page1.bgImage = [UIImage imageNamed:@"guide01"];
   // page1.titleImage = [UIImage imageNamed:@"original"];
    ...
    page2.bgImage = [UIImage imageNamed:@"guide02"];
   // page2.titleImage = [UIImage imageNamed:@"supportcat"];
    ...
    page3.bgImage = [UIImage imageNamed:@"guide03"];
...
//    //page3.title = @"This is page 3";
//    //page3.desc = @"Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.";
//    page4.bgImage = [UIImage imageNamed:@"guide04"];
    
    UIView *viewForPage2 = [[UIView alloc] initWithFrame:self.view.bounds];
    UIImageView *backgroundView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"guide04"]];
    backgroundView.frame = self.view.bounds;
    [viewForPage2 addSubview:backgroundView];
    
    UIButton *btn = [UIButton buttonWithType:UIButtonTypeRoundedRect];
   // [btn setBackgroundImage:[UIImage imageNamed:@"skipButton"] forState:UIControlStateNormal];
   
    [btn setFrame:CGRectMake(35,350, 224, 57)];
   ...
   // [btn setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
    ...
    [viewForPage2 addSubview:btn];
    
    EAIntroPage *page4 = [EAIntroPage pageWithCustomView:viewForPage2];
